...
namespace _1C
{
	...
	/// <summary>
	/// Тип отключения пользователей
	/// 0: Kill - безусловной разрыв соединения
	/// 1: StandartParam - через параметры стандартных конфигураций ЗавершитьРаботуПользователей и РазрешитьРаботуПользователей
	/// 2: UserProc - через пользовательские функции ЗавершитьРаботуПользователей() и РазрешитьРаботуПользователей()
	/// </summary>
	public enum TypeKillUsers{
		Kill = 0,
		StandartParam = 1,
		UserProc = 2,
		None =3
